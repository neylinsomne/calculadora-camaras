...
type PrintQuotePropiosProps = {
    cartItems: Array<{
        id: string;
        nombre: string;
        cantidad: number;
        selectedSolutionIds: string[];
        rowTotalBaseUsd: number;
    }>;
    solutionsData: SolutionDef[];
    globalMarginPercent: number;
    exchangeRate: number;
    className?: string;
};

function PrintQuotePropios({
    cartItems,
    solutionsData,
    globalMarginPercent,
    exchangeRate,
